...
if __name__ == "__main__":
    ...
    TEST_DATASET_WHOLE_SCENE = DLRDatasetWholeScene(root=r"D:\Datasets\PointClouds\nps" , block_points=NUM_POINT, split='test', test_project="MorrisCollege_Pinson", stride=15.0, block_size=30.0, padding=0.001, labels_path="D:\Repos\pointnetpytorch\DLR_Pointnet_Pointnet2_pytorch\data_utils\labels_clean.txt")
